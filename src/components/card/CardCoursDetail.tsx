...
const CardCoursDetail: React.FC<CardCoursDetailProps> = ({
  ...
  const handleStatusChange = async (
    ...
    console.log(`Changing status to: ${newStatus} for ${userSubscriptionId}`);
    ...
    if (success) {
      ...
      console.error("Erreur lors de la mise à jour du statut d'un utilisateur");
      setFetchError("Erreur lors de la mise à jour du statut d'un utilisateur");
    }
  };
                              ...
                              {user.Subscription.status ===
                                ...
                                <>
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      handleOpenModal(user.uploadedDocs ?? [])
                                    }
                                  >
                                    Voir documents
                                  </button>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-[#1f262e] rounded-lg p-6 w-96 flex flex-col gap-4">
            <h4 className="text-lg font-bold mb-4">Documents téléchargés</h4>
            <div className="grid grid-cols-2 gap-2">
              {selectedUserDocs.length > 0 ? (
                ...
                <p className="col-span-2">Aucun document disponible</p>
              )}
            </div>
            <button
